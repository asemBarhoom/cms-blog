...
@section('content')
    @include('posts.partials.header', ['title' => __('Add Post')])   
                                ...
                                <div class="col-9">
                                    <div class="pl-lg-4">
                                        ...
                                        <div class="form-group{{ $errors->has('body') ? ' has-danger' : '' }}">
                                            ...
                                            <textarea name="body" id="summernote" class="form-control form-control-alternative{{ $errors->has('body') ? ' is-invalid' : '' }}" >{{ old('body') }}</textarea>
                                            @if ($errors->has('body'))
                                                <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-3">
                                    ...
                                    @foreach($categories as $category)
                                        <div class="custom-control custom-checkbox mb-3">
                                            <input class="custom-control-input" id="{{$category->id}}" value="{{$category->id}}" type="checkbox" name="categories[]">
